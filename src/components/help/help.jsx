  ...
  return (
    <div className={styles.help}>
      ...
      <div className={styles.helpItem}>
        ...
        <p>
          Currently, an internet connection is required to fetch Bible texts,
          but offline support is planned for future updates.
        </p>
      </div>
      <div className={styles.helpItem}>
        ...
        <p>
          ...
          <a href="mailto:andrejkoller@outlook.com">andrejkoller@outlook.com</a>
        </p>
      </div>
      <div className={styles.helpItem}>
